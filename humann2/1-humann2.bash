...
#SBATCH --job-name=HumanN2_isolated
#SBATCH --account=dw30
#SBATCH -p comp
#SBATCH -N 1
#SBATCH -n 1
...
do
        ...
        "/usr/local/humann/2.0/humannv2.0/bin/humann2" --input ${floCatFiles}${catname} --output ${flooutFolder}${z} --protein-database $uniref_database --nucleotide-database $chocophlan_database
done
...
do
        ...
        #Run HumanN2 on the catfile
        "/usr/local/humann/2.0/humannv2.0/bin/humann2" --input ${hamdiCatFiles}${catname} --output ${hamdioutFolder}${z} --protein-database $uniref_database --nucleotide-database $chocophlan_database
done
